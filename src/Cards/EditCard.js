...
/**
 * Allows to modify information on the deck
 * @params
 * 
 * @returns
...
export const EditCard = () => {
    ...
    // to push the deck name in the breadcrumbs
    useEffect(() => {
    ...
    // to get the front and back of card
    useEffect(() => {
        const abortController = new AbortController();
    ...
    // If clicked submit, the form is submitted and then return to the homepage
